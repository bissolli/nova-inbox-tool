<template>
    <div>
        <heading class="mb-6">{{ __('Nova Inbox Tool') }}</heading>

        <loading-card :loading="true" class="flex flex-wrap py-8 mb-8 text-center">
            <notification-card header="Notifications Sent" :value="1"></notification-card>
            <notification-card header="Notifications Failed" :value="2"></notification-card>
        </loading-card>
        ...
        <card class="bg-90 flex flex-col items-center justify-center" style="min-height: 300px">
            ...
            <p class="text-white-50% text-lg">
                ...
                <code class="ml-1 border border-80 text-sm font-mono text-white bg-black rounded px-2 py-1">/nova-components/NovaInboxTool/resources/js/components/Tool.vue</code>
            </p>
        </card>
    </div>
